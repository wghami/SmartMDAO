...
**State as of v1.23.0:** `main` is clean. 666 tests, 100% coverage, 29/29 scripts, 16 notebooks.
...
project using the MCP connector — is under way in the [roadmap](roadmap.md): 6.1 (declared inputs) is done, 6.2 is next.
...
uv run pytest                        # 666 tests, 100% coverage
...
**Phases 0–5 are complete. Phase 6 is under way; 6.1 is done, start at 6.2.** Phase 6 comes from
