...
project using the MCP connector — is under way in the [roadmap](roadmap.md): 6.1–6.3 made 1.24.0 and 6.4 makes 1.25.0; 6.5 is next.
...
**Phases 0–5 are complete. Phase 6 is under way; 6.1–6.4 make 1.24.0 and 1.25.0, start at 6.5.** Phase 6 comes from
